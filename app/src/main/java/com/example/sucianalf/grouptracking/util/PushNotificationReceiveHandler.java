 ...
 * This will be called when a notification is
 * received while your app is running.
 */

public class PushNotificationReceiveHandler implements OneSignal.NotificationReceivedHandler {
    @Override
